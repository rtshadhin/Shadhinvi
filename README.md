...
Shadhin.js : ``configure auto restart and auto accept pending messages.``</br>
Shadhin.json : ``configure bot name, bot prefix, bot operators and admins.``</br>
shadhinstate.json : ``account cache data.``
...
## HOW TO GET 'SHADHIN.JSON' DATA?

to get ``Shadhin.json`` data, please follow these steps :</br>
